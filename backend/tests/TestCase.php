...
abstract class TestCase extends BaseTestCase
{
    ...
    static function makeSeededInbox($numThreads = 5, $numMessagesPerThread = 3) {
    ...
    static function connectUserToInbox($user, $inbox, $permissionLevel=Group::INBOX_PERMISSION_READWRITE)
    {
